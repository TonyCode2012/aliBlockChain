...
docker exec cli peer chaincode invoke -o orderer.example.com:7050 -C mychannel -n ali -c '{"Args":["getRecord","1002","2009"]}'
docker exec cli peer chaincode invoke -o orderer.example.com:7050 -C mychannel -n ali -c '{"Args":["getRecord","1001","2008"]}'
...
docker exec cli peer chaincode invoke -o orderer.example.com:7050 -C mychannel -n ali -c '{"Args":["getRecord","1002","2014"]}'
...
docker exec cli peer chaincode invoke -o orderer.example.com:7050 -C mychannel -n ali -c '{"Args":["decRecord","1009","2018"]}' --transient "{\"DECKEY\":\"1234567887654321\"}"
docker exec cli peer chaincode invoke -o orderer.example.com:7050 -C mychannel -n ali -c '{"Args":["decRecord","1010","2018"]}' --transient "{\"DECKEY\":\"1234567887654321\"}"
